...
public final class Board {
	...
	/**
	 * Snaps to a heading, given the current odometer heading
	 * @param odometer
	 */
	...
	/**
	 * Getter for the tunnel orientation relative to starting corner 0.
	 * @return
	 */
